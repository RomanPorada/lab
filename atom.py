...
class Atom:
    ...
    def __init__(self, name = "невідомо", atomic_mass_unit = 1, neutrons_number = 1, protons_number = 1, electrons_number = 1, chemical_record = "Невідомо", atom_tupe = AtomType.STABLE):
        self.name = name
    ...
    def __repr__(self):
        return f"{self.name}(mass: {self.atomic_mass_unit}, neutrons: {self.neutrons_number}, protons: {self.protons_number}, electrons: {self.electrons_number}, type: {self.atom_tupe.name})"
